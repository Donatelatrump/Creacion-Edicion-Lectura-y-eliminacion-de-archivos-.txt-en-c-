...
void lectura() {
    ...
    cout << "Que archivo desea abrir: (escriba el nombre del archivo seguido con .txt)\nAcontinuacion vera una lista de archivos dentro de la carpeta del programa\n\n\n";
...
int main() {
  ...
  string opcion;
  while (opcion != "s") {
    cout << "\t\tIngresa c para crear un archivo, e para editar un archivo,\n\t\tl para leer un archivo, d para eliminar un archivo, y s para salir\n";
    cout << VERDE "> " NC;
    cin >> opcion;
    system("cls");
    if (opcion == "c") {
